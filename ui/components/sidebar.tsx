                    ...
                    >
                      <Link href={item.href} className="flex items-center">
                        ...
                        {!isCollapsed && item.badge && (
                          <span className="ml-auto flex h-5 w-5 items-center justify-center rounded-full bg-gray-900 dark:bg-gray-100 text-[10px] text-white dark:text-gray-900 font-medium">
                            {item.badge}
                          </span>
                        )}
                      </Link>
