...
export const CatchGroupNode = memo(({ data, selected }: NodeProps) => {
    ...
    <div
      className={`relative rounded-lg border-2 border-dashed bg-card/30 ${
        disconnected
          ...
          : selected
            ? "ring-2 ring-primary border-red-400 dark:border-red-700"
...
CatchGroupNode.displayName = "CatchGroupNode";
